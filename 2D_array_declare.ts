...
for(let row = 0; row < twoD_Mrr.length;  row++){
    for(let col = 0; col < twoD_Mrr[row].length; col++) console.log(twoD_Mrr[row] [col] ); // prints hi 3 9 super bala joy (horizontal way)   
}
console.log('\n-----------');

// 2. via for in loop
for(const row in twoD_Mrr){
    for(const col in twoD_Mrr[row]) console.log(twoD_Mrr[row] [col] );  // prints hi 3 9 super bala joy (horizontal way)
}
console.log('\n--------------------');
...
for(const row of twoD_Mrr){  
    for(const elem of row) console.log(elem);           // prints hi 3 9 super bala joy (horizontal way)
}
...
twoD_Mrr.forEach(row => {
    row.forEach(elem => console.log(elem) );            // prints hi 3 9 super bala joy (horizontal way)
} );
