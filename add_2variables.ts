...
// one tougher way of writing return type after =>
let myAdd : (x : number, y : number) => number =               // wrote fn() return type after =>
    function(x : number, y : number) : number{ 
        return x + y;               
    };

console.log(myAdd(9, 0) );                      // prints 9         
console.log('\n=========================');
...
// 3- using no data types inside fn() signature (disable // "strict": true,  in tsconfig.json to run below lines of code)
const add3 = (a, b) => a + b;
