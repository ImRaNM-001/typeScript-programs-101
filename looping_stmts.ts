...
while(i < 7){
    console.log(i);                 // prints 1 2 3 4 5 6 (horizontal way)
    i++;    
}
...
while(i < 7){
    if(i % 2 === 0){
        console.log(i);                          // prints 2 4 6 (horizontal way)
    }
    i++;    
}
...
i = 6;
while(i > 0){
    console.log(i);                     // prints 6 5 4 3 2 1 (horizontal way)
    i--;    
}
...
while(i > 0);                         // prints 6 5 4 3 2 1 (horizontal way)


// 3- for loop, ex 1: printing 1 to 6
for(let y : number = 1;  y < 7;  y++) console.log(y);                     // prints 6 5 4 3 2 1 (horizontal way)
...
for(let y : number = 2; y < 7;  y++){
    if(y % 2 === 0) console.log(y);                   // prints 2 4 6 (horizontal way)
}

console.log('\n-----------');       

// ex 4: printing even nos (SDET way)
for(let y : number = 2; y < 7;  y+=2) console.log(y);        // prints 2 4 6 (horizontal way)


console.log('\n-----------');

// ex 5: print nos in descending order
for(let y : number = 6; y > 0;  y--) console.log(y);             // prints 6 5 4 3 2 1 (horizontal way)
...
for(let k : number = 21;    k < 101;    k++){
    if(k === 28) break;
    console.log(k);                                 // prints 21 22 23 24 25 26 27 (horizontal way)     
}
console.log('\n-----------'); 
...
for(let k : number = 21;    k < 31;    k++){
    if(k === 29) continue;
    console.log(k);                                 // prints 21 22 23 24 25 26 27 28 30 (horizontal way), basically if stmt here plays the role of ignore statment     
}
console.log('\n-----------'); 
...
for(let k : number = 21;    k < 31;    k++){
    if(k <= 27) continue;
    console.log(k);                                                 // prints 28 29 30 (horizontal way)
}
